                          ...
                          bool profile = false)
{
    ...
    cta_level_visimergesort<launch_t>(dev_viewrays.data(), context, seg_count, profile);

    viewray<T> *dev_output = kernel_visimerge<launch_t>(dev_viewrays.data(), dev_buffer.data(), context,
                             seg_count, vr_count, -1, profile);
